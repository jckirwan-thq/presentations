...
| [`automated-fix-versions/`](./automated-fix-versions/) | Automated Fix Versions — Sisyphus Gets a Day Off | Jean-Claude Kirwan | https://tradifyhq.github.io/presentations/automated-fix-versions/ |
