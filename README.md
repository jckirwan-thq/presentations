...
| [`automated-fix-versions/`](./automated-fix-versions/) | Automated Fix Versions — The Sisyphus Job | Jean-Claude Kirwan | https://jckirwan-thq.github.io/presentations/automated-fix-versions/ |
